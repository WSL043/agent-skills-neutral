...
2. Name the purpose of each candidate motion: orientation, feedback, continuity, hierarchy, or delight.
...
- Use no motion when it delays a repeated action or lacks informational value.
