...
IMPLEMENTATION = {
    ...
    "work-with-postgresql": "Inspect PostgreSQL runtime, schema, workload, plans, locks, and access policy; make the smallest reversible change and verify integrity, security, and representative behavior.",
